            ...
            >
              <div className="flex flex-col px-10 text-gray-700 py-5 md:w-1/2 w-full">
                ...
                <ul className="flex flex-wrap justify-around md:justify-start pt-2 space-x-3 2xl:pb-5 2xl:pt-5">
                  {project.tags.map((tag, index) => (
                    <li
                      className=" bg-gradient-to-b from-[#FFFBDA] via-[#FFEC9E] via-[#FFBB70] to-[#ED9455] px-2 py-1 text-gray-600 rounded-full text-gray-300 text-sm"
                      key={index}
                    >
                      #{tag}
                    </li>
              ...
              <div className="relative h-full mt-10">
                ...
                {currImg[idx] === 0 ? (
                  ...
                  <>
                    <div className="absolute md:top-10 2xl:top-20 bottom-10 pb-10 left-0 flex items-center">
                      <button
                ...
                <div className="absolute ml-10 md:top-10 2xl:top-20 bottom-10 pb-10 right-0 flex items-center">
                  <button
                    className="bg-slate-300 bg-opacity-60 rounded-full px-2 py-2"
                    type="button"
